...
const startForm = async (req, res, next) => {
  try {
    ...
    const form = gradingService.getForm(itemId);
...
const getForm = async (req, res, next) => {
  try {
    const form = gradingService.getForm(req.params.itemId);
...
module.exports = { triggerGrading, getGrade, health, getFlaggedGrades, startForm, getForm };
